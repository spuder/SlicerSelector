...
on handleSlicerSelection(theFile)
    set slicerList to {"AnkerMake Studio", "BambuStudio", "Blender", "ChiTuBox", "IdeaMaker", "LycheeSlicer", "MatterControl", "OpenSCAD", "OrcaSlicer", "Proton Workshop", "PrusaSlicer", "Simplify3D", "Slic3r", "Slicer", "SuperSlicer", "ThumbHost3mf", "UltiMaker Cura"}
